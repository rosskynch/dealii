...
integratedLegendreSZ::recursive_coefficients(20);

std::vector<std_cxx11::shared_ptr<const std::vector<double> > >
integratedLegendreSZ::shifted_coefficients(20);
...
void
integratedLegendreSZ::compute_coefficients (const unsigned int k_)
{
